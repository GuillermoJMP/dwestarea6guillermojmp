...
public class PedidoController {
    ...
    public String anadirAlCarrito(@RequestParam Long plantaId,
                                  @RequestParam int cantidad,
                                  HttpSession session,
                                  RedirectAttributes redirectAttributes) {
        List<Ejemplar> ejemplaresDisponibles = ejemplarService.filtrarPorPlanta(plantaId)
                .stream()
                .filter(e -> e.isDisponible())
                .toList();
    ...
    public String anadirAlCarritoMultiple(@RequestParam List<Long> plantaIds,
    ...
    public String confirmarPedido(HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        sb.append("El usuario ").append(cliente.getNombre())
          .append(" realizó un pedido con ").append(ejemplaresPedido.size()).append(" ejemplares: ");
